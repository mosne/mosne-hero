...
(function () {
  ...
  function initFocalPointSwitching() {
    ...
    const pictureElements = document.querySelectorAll('.has-mobile-image picture.wp-block-cover__image-background');
    ...
    pictureElements.forEach(picture => {
      ...
      const mobileObjectPosition = img.getAttribute('data-object-position') || img.style.objectPosition || '50% 50%';
      const desktopObjectPosition = img.getAttribute('data-desktop-object-position') || '50% 50%';
